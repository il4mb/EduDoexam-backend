...
import { examOwner, userExtractor, examAdminParticipant } from '../utils/middleware';
import { getUserById } from '../utils/helpers/user';
import { getFirestore, Timestamp } from 'firebase-admin/firestore';
import { convertFirestoreData } from '../utils/converter';

import participantRoute from "./exams.doc.participants";
import questionsRoute from "./exams.doc.questions";
import answersRoute from "./exams.doc.answers";
