...
export const classParticipants = async (req: Request & { classData?: any; user?: any }, res: Response, next: NextFunction) => {
...
export const classUpdateValidator = (req: Request, res: Response, next: NextFunction) => {
...
export const classAdminParticipant = async (req: Request & { user: any }, res: Response, next: NextFunction) => {
