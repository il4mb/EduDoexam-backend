...
import { getFileUrl } from "../../utils/cloudStorage.js";
export const getUserById = async (id, props = ["id", "name", "photo"]) => {
    ...
    const data = doc.data();
    const filteredData = Object.fromEntries(Object.entries(data).filter(([key]) => props.includes(key)));
